...
class BaseEvents extends Worker
{
    ...
    public static function onConnect($client_id) {
        ...
        //检查许可
        //$res = app('License')->validate($client_id);
    ...
    public static function onMessage($client_id, $message) {
        ...
        //验证过期时间
        //$res = app('License')->validate_ip_time($client_id);

        Log::info(__NAMESPACE__. "/".__CLASS__."/".__FUNCTION__."@".__LINE__." START".PHP_EOL." client:$client_id , new message1234:". bin2hex($message));
