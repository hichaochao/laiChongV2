...
class StartChargeSend implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        $evseController->startChargeSend($this->monitor_order_id, $this->monitor_code, $this->port_numbers, $this->charge_time, $this->order_no);
    }
