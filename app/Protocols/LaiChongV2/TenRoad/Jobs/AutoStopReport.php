...
class AutoStopReport implements ShouldQueue
{
     ...
     * @return void
     */
    public function __construct($code, $order_number, $start_type, $left_time, $stop_reason)
    {
    ...
    public function handle()
    {
        ...
        $evseController->autoStopReport($this->code, $this->order_number, $this->start_type, $this->left_time, $this->stop_reason);
