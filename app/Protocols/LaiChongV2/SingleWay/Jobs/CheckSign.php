...
class CheckSign implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        $evseController->checkSign($this->code, $this->num, $this->device_identification, $this->heabeat_cycle, $this->worker_id, $this->version);
