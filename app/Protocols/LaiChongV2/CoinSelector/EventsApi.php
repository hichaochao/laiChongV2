...
//桩自动停止
use Wormhole\Protocols\QianNiu\Protocol\Evse\AutomaticStop as EvseAutomaticStop;
use Wormhole\Protocols\QianNiu\Protocol\Server\AutomaticStop as ServerAutomaticStop;

//状态上报
use Wormhole\Protocols\QianNiu\Protocol\Evse\Statusreport as EvseStatusreport;

//日结
use Wormhole\Protocols\QianNiu\Protocol\Evse\Report as EvseReport;
...
use Wormhole\Protocols\QianNiu\Protocol\Evse\StartCharge as EvseStartCharge;

//续费
use Wormhole\Protocols\QianNiu\Protocol\Server\Renew as ServerRenew;
use Wormhole\Protocols\QianNiu\Protocol\Evse\Renew as EvseRenew;

//停止充电
use Wormhole\Protocols\QianNiu\Protocol\Server\StopCharge as ServerStopCharge;
use Wormhole\Protocols\QianNiu\Protocol\Evse\StopCharge as EvseStopCharge;

//心跳设置
use Wormhole\Protocols\QianNiu\Protocol\Server\SetHearbeat as ServerSetHearbeat;
use Wormhole\Protocols\QianNiu\Protocol\Evse\SetHearbeat as EvseHearbeat;

//服务器信息设置
use Wormhole\Protocols\QianNiu\Protocol\Server\ServerInfo as ServerInfo;
use Wormhole\Protocols\QianNiu\Protocol\Evse\ServerInfo as EvseServerInfo;

//清空营业额
use Wormhole\Protocols\QianNiu\Protocol\Server\EmptyTurnover as ServerEmptyTurnover;
use Wormhole\Protocols\QianNiu\Protocol\Evse\EmptyTurnover as EvseEmptyTurnover;

//设置参数
use Wormhole\Protocols\QianNiu\Protocol\Server\SetParameter as ServerSetParameter;
use Wormhole\Protocols\QianNiu\Protocol\Evse\SetParameter as EvseSetParameter;

//设置ID
use Wormhole\Protocols\QianNiu\Protocol\Server\SetId as ServerSetId;
use Wormhole\Protocols\QianNiu\Protocol\Evse\SetId as EvseSetId;

//心跳查询
use Wormhole\Protocols\QianNiu\Protocol\Server\GetHearbeat as ServerGetHeartbeat;
use Wormhole\Protocols\QianNiu\Protocol\Evse\GetHearbeat as EvseGetHeartbeat;

//电表抄表
use Wormhole\Protocols\QianNiu\Protocol\Server\ReadMeter as ServerReadMeter;
use Wormhole\Protocols\QianNiu\Protocol\Evse\ReadMeter as EvseReadMeter;

//营业额查询
use Wormhole\Protocols\QianNiu\Protocol\Server\GetTurnover as ServerGetTurnover;
use Wormhole\Protocols\QianNiu\Protocol\Evse\GetTurnover as EvseGetTurnover;

//通道查询
use Wormhole\Protocols\QianNiu\Protocol\Server\GetChannelStatus as ServerGetChannelStatus;
use Wormhole\Protocols\QianNiu\Protocol\Evse\GetChannelStatus as EvseGetChannelStatus;

//查询参数
use Wormhole\Protocols\QianNiu\Protocol\Server\GetParameter as ServerGetParameter;
use Wormhole\Protocols\QianNiu\Protocol\Evse\GetParameter as EvseGetParameter;

//设置时间
use Wormhole\Protocols\QianNiu\Protocol\Evse\SetDateTime as EvseSetDateTime;

//查询时间
use Wormhole\Protocols\QianNiu\Protocol\Evse\GetDateTime as EvseGetDateTime;

//查询ID
use Wormhole\Protocols\QianNiu\Protocol\Evse\GetId as EvseGetId;

//查询设备识别号
use Wormhole\Protocols\QianNiu\Protocol\Evse\GetDeviceIdentification as EvseGetDeviceIdentification;
...
//签到
use Wormhole\Protocols\QianNiu\Jobs\SignReport;
//自动停止
use Wormhole\Protocols\QianNiu\Jobs\AutoStopReport;
//日结
use Wormhole\Protocols\QianNiu\Jobs\TurnoverReport;
//心跳
use Wormhole\Protocols\QianNiu\Jobs\HeartBeatReport;

//启动充电响应
use Wormhole\Protocols\QianNiu\Jobs\StartChargeResponse;
//续费响应
use Wormhole\Protocols\QianNiu\Jobs\RenewResponse;
//停止充电响应
use Wormhole\Protocols\QianNiu\Jobs\StopChargeResponse;
